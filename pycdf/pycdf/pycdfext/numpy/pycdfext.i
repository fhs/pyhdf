/*
 * $Id: pycdfext.i,v 1.1 2007-02-11 22:07:33 gosselin_a Exp $
 * $Name: not supported by cvs2svn $
 * $Log: not supported by cvs2svn $
 *
 * SWIG directives for generating the pycdfext module for use with numpy.
 */
...
/* Emulate Numeric declarations through numpy odlnumeric device */
